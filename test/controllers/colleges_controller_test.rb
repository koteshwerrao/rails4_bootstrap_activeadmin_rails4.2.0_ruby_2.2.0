...
class CollegesControllerTest < ActionController::TestCase
  ...
  test "should create college" do
    assert_difference('College.count') do
      post :create, college: { address: @college.address, number: @college.number, ph_no: @college.ph_no, student_name: @college.student_name }
    end
  ...
  test "should update college" do
    patch :update, id: @college, college: { address: @college.address, number: @college.number, ph_no: @college.ph_no, student_name: @college.student_name }
    assert_redirected_to college_path(assigns(:college))
  end
